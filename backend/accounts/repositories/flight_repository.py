from accounts.models import Flight
...
class FlightRepository:
    def get_by_id(self, flight_id):
        return (
            Flight.objects.select_related(
                "airline_company", "origin_country", "destination_country"
            )
            .filter(id=flight_id)
            .first()
        )
    ...
    def get_arrival_flights(self, country_id):
        ...
        return Flight.objects.select_related(
            "airline_company", "origin_country", "detination_country"
        ).filter(destination_country_id=country_id, landing_time__range=(now, limit))
    ...
    def get_departure_flights(self, country_id):
        ...
        return Flight.objects.select_related(
            "airline_company", "origin_country", "detination_country"
        ).filter(origin_country_id=country_id, departure_time__range=(now, limit))
